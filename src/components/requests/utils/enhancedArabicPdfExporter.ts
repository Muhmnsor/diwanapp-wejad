...
// Add the Amiri font for better Arabic support
import amiriRegular from '../../../fonts/Amiri-Regular.js';
import amiriBold from '../../../fonts/Amiri-Bold.js';

/**
 * Configure PDF for proper Arabic text rendering
 */
const configurePdfForArabic = (pdf: jsPDF): jsPDF => {
  // Add the Amiri font for Arabic text
  pdf.addFileToVFS('Amiri-Regular.ttf', amiriRegular);
  pdf.addFileToVFS('Amiri-Bold.ttf', amiriBold);
  pdf.addFont('Amiri-Regular.ttf', 'Amiri', 'normal');
  pdf.addFont('Amiri-Bold.ttf', 'Amiri', 'bold');
  
  // Set font and RTL mode
  pdf.setFont('Amiri');
  pdf.setR2L(true);
...
/**
 * Add request header information to the PDF
 */
...
/**
 * Add request form data to the PDF
 */
...
/**
 * Add approvals history to the PDF
 */
...
/**
 * Add verification QR code to the PDF
 */
...
/**
 * Main export function to generate PDF with Arabic support
 */
