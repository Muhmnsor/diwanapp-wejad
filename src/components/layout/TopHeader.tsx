...
          <div className="flex items-center justify-between py-2 md:py-4 gap-2">
            <Logo />
            <div className="flex items-center gap-2">
              {isAuthenticated && user && <div className="hidden md:flex items-center gap-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-md shadow-sm ms-2 py-2 px-3">
...
              <div className="flex justify-start overflow-x-auto px-2">
                <div className="flex gap-3 md:gap-6 items-center min-w-max">
...
                    <FolderKanban className="h-5 w-5 md:h-4 md:w-4" />
...
                        <BarChart4 className="h-5 w-5 md:h-4 md:w-4" />
