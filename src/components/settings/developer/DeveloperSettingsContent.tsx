...
import { Loader2, Save, RefreshCw, Clock, Gauge, Bug, Database, Activity, Shield } from "lucide-react";
...
export const DeveloperSettingsContent = ({ 
  permissions,
  handleToggleDeveloperRole,
  roleAssigning,
  handleRefresh 
}: {
  permissions: {
  ...
  handleToggleDeveloperRole: () => Promise<void>;
  roleAssigning: boolean;
  handleRefresh: () => Promise<void>;
}) => {
  const { settings, isLoading, updateSettings } = useDeveloperStore();
