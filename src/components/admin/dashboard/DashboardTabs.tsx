  ...
  return (
    <Tabs defaultValue="overview" className="w-full space-y-6">
      ...
      <TabsContent value="overview" className="space-y-6">
        <DashboardOverviewTab projectId={projectId} isEvent={isEvent} />
      </TabsContent>

      <TabsContent value="registrations" className="space-y-6">
        <DashboardRegistrationsTab projectId={projectId} isEvent={isEvent} />
      </TabsContent>
      ...
      <TabsContent value="reports" className="space-y-6">
        <DashboardReportsTab projectId={projectId} isEvent={isEvent} />
      </TabsContent>
    </Tabs>
  );
};