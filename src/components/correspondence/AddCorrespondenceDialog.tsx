      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input name="subject" id="subject" placeholder="أدخل موضوع المعاملة" required />
          </div>
          ...
          {type === 'incoming' ? (
            <>
              <div>
                ...
                <Input name="sender" id="sender" placeholder="الجهة المرسلة" required />
              </div>
              
              <div>
                <Label htmlFor="recipient_select">موجهة إلى</Label>
            ...
            <>
              ...
              <div>
                ...
                <Input name="recipient" id="recipient" placeholder="الجهة المستلمة" required />
              </div>
            </>
          )}
        </div>
        ...
        <div>
          ...
          <Textarea name="content" id="content" placeholder="أدخل محتوى المعاملة" rows={5} required />
        </div>
        ...
        {type !== 'incoming' && (
          <div>
            ...
            <Textarea name="notes" id="notes" placeholder="أية ملاحظات إضافية" />
          </div>
        )}
