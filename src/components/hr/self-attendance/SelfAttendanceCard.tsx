...
  // Line ~35-40: Add timezone handling
  const [currentTime, setCurrentTime] = useState(new Date().toLocaleString("en-US", {timeZone: "Asia/Riyadh"}));
...
      setCurrentTime(new Date().toLocaleString("en-US", {timeZone: "Asia/Riyadh"}));
    }, 60000);
...
  // Line ~270-275: Update time display
  const formattedTime = new Date(currentTime).toLocaleTimeString('ar-SA', { 
    hour: '2-digit', 
    minute: '2-digit',
