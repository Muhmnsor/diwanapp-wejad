    ...
    <div className="mb-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
        <div className="flex items-center gap-2 mb-4 sm:mb-0">
          ...
          <h2 className="text-xl font-semibold">المستخدمين ({users.length})</h2>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4 mb-6">
        ...
        {Object.entries(rolesCounts).slice(0, 2).map(([role, count]) => (
          <div key={role} className="bg-muted/30 rounded-lg p-4 flex flex-col gap-2">
            <div className="flex items-center gap-2">
