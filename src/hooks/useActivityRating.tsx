...
export const useActivityRating = (projectId: string) => {
  return useQuery({
    queryKey: ['activity-rating', projectId],
    queryFn: async () => {
      console.log('Fetching activities ratings for project:', projectId);
      ...
      console.log('Final activities rating:', {
        totalRating,
        totalFeedbackCount,
